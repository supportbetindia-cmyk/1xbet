...
export const CategoryBrowser: React.FC<CategoryBrowserProps> = ({ onSelectGame }) => {
  ...
  return (
    <section className="relative border-t border-line bg-surface-1 py-8 sm:py-9 lg:py-10">
      <div className="mx-auto w-full max-w-[1600px] px-4 sm:px-6 lg:px-10">
        ...
        {games.length === 0 ? (
          ...
          <Rail
            scrollRef={gridRef}
            className="mt-7"
            grid="sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6"
            gap="gap-3 lg:gap-4"
            card="40%"
            label="Games in this category"
          >
            {games.map((g) => (
